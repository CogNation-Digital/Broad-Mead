...
<head>
    ...
    <title>Under Maintanance and Update</title>
</head>
<style>
    html,
    body {
...
<body>
    <main>
        ...
        <h1>Under Maintanance and Update</h1>
        <h2>Sorry for the inconvenience but the system is not available.</h2>
        <h3>Contact the developers for any help.</h3>
    </main>
    <footer>Broad-Mead</footer>
</body>
