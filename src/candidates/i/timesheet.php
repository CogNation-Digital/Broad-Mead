            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $n = 1;
                        $_timesheet_query = "SELECT * FROM `_timesheet` WHERE (CandidateID = '$CandidateID') AND DATE(Date) BETWEEN '$FromDate' AND '$ToDate'";
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <?php if (IsCheckPermission($USERID, "DELETE_TIMESHEET")) : ?>
                                                <a class="dropdown-item select-entry-row" href="#" data-bs-toggle="modal" data-bs-target="#DeleteModal">
                                                    ...
                                                    Delete</a>
                                            <?php endif; ?>
                                            <a class="dropdown-item select-entry-row" href="#" id="View">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <select name="candidate" class="select-input">
                                            <?php
                                            $_query = "SELECT * FROM `_candidates` WHERE CandidateID = '$CandidateID'";
