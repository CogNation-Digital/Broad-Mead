<?php if ($isTab == "Emergency") : ?>
    <div class="card-body table-border-style">
        <div style="margin-bottom: 20px;" class="d-flex align-items-center justify-content-between">
            ...
            <?php
            $hasPermission = IsCheckPermission($USERID, "CREATE_EMERGENCY_CONTACT") ||
                IsCheckPermission($USERID, "EDIT_EMERGENCY_CONTACT") ||
                IsCheckPermission($USERID, "DELETE_EMERGENCY_CONTACT");
            ...
            if ($hasPermission) : ?>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <?php endif; ?>
                        <?php if (IsCheckPermission($USERID, "EDIT_EMERGENCY_CONTACT")) : ?>
                        ...
                        <?php endif; ?>
                        <?php if (IsCheckPermission($USERID, "DELETE_EMERGENCY_CONTACT")) : ?>
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                    $n = 1;
                    $query  = $conn->query("SELECT * FROM `_candidates_kins` WHERE CandidateID = '$CandidateID'");
                    while ($row = $query->fetchObject()) { ?>
                        <tr>
                            <td><?php echo $n++; ?></td>
                            <td style="display: none;"> <input class="form-check-input checkbox-item" type="checkbox" value="<?php echo $row->id; ?>" data-Relationship="<?php echo $row->Relationship; ?>" data-Contact="<?php echo $row->Contact; ?>" data-name="<?php echo $row->Name; ?>" id="flexCheckDefault<?php echo $row->id ?>"> </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="CreateModalLabel">Create Emergency Contact</h5><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <?php if (IsCheckPermission($USERID, "CREATE_EMERGENCY_CONTACT")) : ?>
                    <form method="POST" enctype="multipart/form-data">
                        <div class="modal-body row">
                            ...
                            <div class="col-md-12" style="padding: 10px;">
                                ...
                                <input required type="text" name="Relationship" class="form-control" required>
                            </div>
                            ...
                            <div class="col-md-12" style="padding: 10px;">
                                ...
                                <input required type="text" name="PhoneNumber" class="form-control" required>
                            </div>


                        </div>
                        <div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="submit" name="CreateEmergencyContact" class="btn btn-primary">Submit</button>
                        </div>
                    </form>
    ...
    <div id="EditModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="EditModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="EditModalLabel">Edit Contact</h5><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <?php if (IsCheckPermission($USERID, "EDIT_EMERGENCY_CONTACT")) : ?>
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="submit" name="UpdateEmergencyContact" class="btn btn-primary">Submit</button>
                        </div>
                    </form>
